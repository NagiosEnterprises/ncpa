...
(
    ...
    # Always source the compiler environment generated by setup.sh
    if [ -f "/tmp/solaris_build_env.sh" ]; then
        echo "Sourcing /tmp/solaris_build_env.sh for compiler environment..."
